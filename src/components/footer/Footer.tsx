          ...
          <div className="flex flex-col items-start md:items-end gap-5">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a
                ...
                className="w-11 h-11 rounded-full bg-canvas-ecru border border-border-subtle shadow-xs flex items-center justify-center text-charcoal hover:border-terracotta hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer"
              >
              ...
              <a
                ...
                className="w-11 h-11 rounded-full bg-canvas-ecru border border-border-subtle shadow-xs flex items-center justify-center text-emerald-600 hover:border-emerald-500 hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer"
              >
